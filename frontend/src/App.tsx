              ...
              {currentStep === 1 && (
                <div className="step-content animate-in">
                  ...
                  <div className="input-grid">
                    ...
                    <div className="input-group"><label className="rich-label"><span><MapPin size={16} /> Location / Address <span className="required-star">*</span></span></label><input type="text" name="address" placeholder="Surat, India" value={formData.address} onChange={handleInputChange} /></div>
                  </div>
                </div>
              )}
